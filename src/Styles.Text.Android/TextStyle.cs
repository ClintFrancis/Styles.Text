		...
		internal void StyleTextView (TextView target, TextStyleParameters style, bool isPlainText, bool ignoreHtml = false)
		{
			...
			if (isPlainText) {
				if (!String.IsNullOrEmpty (style.Color))
					target.SetTextColor (Android.Graphics.Color.White.FromHex (style.Color));
			...
			if (!string.IsNullOrEmpty (style.BackgroundColor))
				target.SetBackgroundColor (Android.Graphics.Color.White.FromHex (style.BackgroundColor));
